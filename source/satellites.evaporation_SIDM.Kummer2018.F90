...
contains
  ...
  function kummer2018ConstructorParameters(parameters) result(self)
    ...
    <inputParameter>
      ...
      <description>
	Determines whether subhalo velocity dispersion will be evaluated in assessing the evaporation coefficient. If
	...
	included in computing the evaporation coefficient. Otherwise, the subhalo velocity dispersion is ignored (as it is
    ...
    !!]
    self=satelliteEvaporationSIDMKummer2018(fractionVelocitySmall,darkMatterParticle_,darkMatterProfileDMO_,galacticStructure_)
    !![
